...
// The request message for logout.
type NilReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
// The response message for logout.
type NilRes struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
// The response message for changing the email.
...
// The user message containing the user details.
type User struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
var file_user_proto_rawDesc = []byte{
	...
	0x78, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c,
	...
	0x52, 0x07, 0x69, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x32, 0xaa, 0x02, 0x0a, 0x04, 0x41, 0x75,
...
var file_user_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auth.Logout:input_type -> auth.NilReq
	6, // 3: auth.Auth.ChangePassword:input_type -> auth.ChangePasswordRequest
	8, // 4: auth.Auth.ChangeEmail:input_type -> auth.ChangeEmailRequest
	1, // 5: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 6: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 7: auth.Auth.Logout:output_type -> auth.NilRes
	7, // 8: auth.Auth.ChangePassword:output_type -> auth.ChangePasswordResponse
	9, // 9: auth.Auth.ChangeEmail:output_type -> auth.ChangeEmailResponse
